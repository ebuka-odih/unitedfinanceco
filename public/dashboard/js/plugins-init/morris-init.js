	...
	var dzMorris = function(){
		...
		var lineChart = function(){
			...
			let line = new Morris.Line({
				...
				lineColors: ['rgb(30, 170, 231)'], //here
				lineWidth: 1,
				hideHover: 'auto',
				pointSize: 0,
				axes: false
		...
		var lineChart2 = function(){
			...
			Morris.Area({
				...
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(30, 170, 231)', 'rgb(43, 193, 85)', '#461EE7'],
				resize: true
		...
		var barChart = function(){
			...
			Morris.Bar({
				...
				ykeys: ['a', 'b', 'c'],
				labels: ['A', 'B', 'C'],
				barColors: ['#1EAAE7', '#2BC155', '#ff9f00'],
				hideHover: 'auto',
				gridLineColor: 'transparent',
				resize: true,
				barSizeRatio: 0.25,
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#461EE7', 'rgb(16, 202, 147)', 'rgb(30, 170, 231)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
