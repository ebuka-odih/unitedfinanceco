        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('homepage') }}" >
                    <h3 style="color: #d96732; font-weight: bolder">United IBF</h3>
{{--                    <img height="100" src="{{ asset('front/logo.png') }}" class="img-responsive" alt="Brand Logo">--}}
                </a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right" >
                    ...
                    <li class="dropdown">
                        <a href="#" style="color: white;">United IBF </a>
                        <ul class="dropdown-menu">
