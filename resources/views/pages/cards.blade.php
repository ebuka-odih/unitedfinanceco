            ...
            <div class="col-md-12 heading" style="padding: 0px; position: relative; height: 100%; background:#336699; ">
                ...
                <div class="holdWriteUp">
                    ...
                    <p class="text-center carryBottom text_white">
                        United IBF makes digital payments and transfers easy with various credit, debit and ATM card options to suit your needs. You'll appreciate the anytime access and other convenient features of these cards.
                    </p>
                    ...
                    <div class="col-md-12">
                        <div class="row" >
                            <div class="col-md-6 col-sm-6">
                                <div  style="background: transparent;">
                                    <div class="feature-box text-center">
                                        <h6 class="title" style="color: #336699;">Credit Cards</h6>
                                        <p class="subtext">Our VISA® credit card options provide the spending power you need from a reliable credit card.</p>
                                        <a href="Credit-Cards.php" class="button button-2x primary-bg button-arrow button-radius">Read More &nbsp; &nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="feature-box-4-grid1 "  style="background: transparent;">
                                    <div class="feature-box text-center">
                                        <h6 class="title" style="color: #336699;">Debit Cards</h6>
                                        <p class="subtext">Your United IBF personal checking account includes one of our feature-rich Debit MasterCard® options. </p>
                        ...
                        <div class="row" >
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="feature-box-4-grid1" style="background: transparent;">
                                    <div class="feature-box text-center">
                                        <h6 class="title" style="color: #336699;">ATM Cards</h6>
                                        <p class="subtext">Our convenient ATM Card allows you to withdraw and transfer money, or make balance inquiries. </p>
                                        <a href="ATM-Cards.php" class="button button-2x primary-bg button-arrow button-radius">Read More &nbsp; &nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="feature-box-4-grid1" style="background: transparent;">
                                    <div class="feature-box text-center">
                                        <h6 class="title" style="color: #336699;">Mobile Wallet</h6>
                                        <p class="subtext">Introducing Mobile Wallet, a safe and easy way to make payments with your HawaiiUSA Debit and Credit Cards.</p>
                                        <a href="{{ route('mobile_wallet') }}" class="button button-2x primary-bg button-arrow button-radius">Read More &nbsp; &nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="signInModal" class="my_modal2 hideModal " style="background: url(images/slider/mobile_slider.png); background-repeat: no-repeat; background-size: cover;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 text-center text_white" style="margin-top: 10px;">
                        Not Yet Registered?<br><a href="login.php" onClick="callRegModal()" class="no_color_on_hover" style="text-decoration: underline;"  >Enroll Now!</a>
                    </div>
