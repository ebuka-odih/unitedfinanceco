            ...
            <div class="col-md-12 heading" style="padding: 0px; position: relative; height: 100%; background:#336699; ">
                ...
                <div class="holdWriteUp">
                    ...
                    <p class="text-center carryBottom text_white">
                        When it comes to managing your personal or business accounts, you'll be able to quickly pay bills, transfer money, apply for certain loans and much more through United IBF Online Banking.
                    </p>
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1 text-left">
                                ...
                                <ul style="margin-top: 20px;">
                                    ...
                                    <li dir="LTR">&#8226;<strong>&nbsp;</strong>Transfer funds between your United IBF and outside accounts</li>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div  style="background: transparent;">
                                    <div class="feature-box text-center">
                                        ...
                                        <p class="subtext">Stop worrying over lost or late payments. Be confident it gets there on-time, every time with Automatic Payments from United IBF Online Banking.</p>
