    ...
    <div  class="content content-boxed">
        ...
        <div class="verification section-padding">
            <div class="container h-100">
                <div class="row justify-content-center h-100 align-items-center">
                    <div class="col-xl-8 col-md-8">
                        <div class="auth-form card">
                            <div class="card-body">
                                <form method="GET" action="{{ route('next_of_kin', auth()->user()->id) }}"  id="form"  class="identity-upload">
                                    @csrf
                ...
                {{--                    <a href="{{ route('user.withdrawal_details', $with_dt->id) }}" class="btn btn-success">Done</a>--}}
            </div>
        </div>
        <!-- Invoice -->
        ...
        if (i == 0) {
            ...
            function frame() {
                if (width >= 100) {
                    ...
                    if(width < 30){
                        elem.innerHTML = 'Initiating User profile ....';
                    }else {
                    ...
                    if(width > 10){
                        ...
                        status.style.color = 'green';
                        status.innerHTML = 'please hold on....';
                    }if(width > 55){
                        status.style.color = 'green';
                    ...
                    if(width > 98){
                        status.style.color = 'green';
                        status.innerHTML = 'Wait... Fill up the form ';
                    }
                }
            }
        }
