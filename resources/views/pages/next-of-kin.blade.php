...
<head>
    ...
    <title>Register | Capecity Bank </title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-center my_heading">
                <h3 style=" color:white;">Next Of Kin (Registeration)</h3>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-lg-12" style="margin-top: 10px;">
                            <form method="POST" enctype="multipart/form-data" action="{{ route('store.nok') }}">
...
{{--                                <input type="hidden" value="{{ \Auth::id() }}" name="user_id">--}}
                                ...
                                <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                    ...
                                    <div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">
                                        ...
                                        <input type="text" class="form-control" name="first_name" placeholder="Enter First Name" value="" required id="kin_first_name">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                    ...
                                    <div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">
                                        <i class="fa fa-user" style="color:#2196F3;"></i>                                      </span>
                                        <input type="text" class="form-control" name="last_name" placeholder="Enter last Name" value="" required id="kin_last_name">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                    ...
                                    <div class="input-group">
                                          <span class="input-group-addon" id="basic-addon1">
                                            <i class="fa fa-user" style="color:#2196F3;"></i>                                          </span>
                                        <select name="gender" class="form-control" id="kin_gender" required>
                                ...
                                <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                    ...
                                    <div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">
                                        <i class="fa fa-user" style="color:#2196F3;"></i>                                      </span>
                                        <input type="text" class="form-control" name="phone" placeholder="Enter Phone" value="" required aria-describedby="basic-addon1" id="kphone">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                    ...
                                    <div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">
                                        ...
                                        <input type="email" class="form-control" name="email" placeholder="Enter Email" value="" required aria-describedby="basic-addon1" id="kemail">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                    ...
                                    <div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">
                                        ...
                                        <input type="text" class="form-control" name="address" placeholder="Enter Address" required id="kin_address">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                    ...
                                    <div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">
                                        ...
                                        <input type="text" class="form-control" name="state" placeholder="Enter State" value="" required aria-describedby="basic-addon1" id="kstate">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                    ...
                                    <div class="input-group">
                                      <span class="input-group-addon" id="basic-addon1">
                                        ...
                                        <input type="text" class="form-control" name="city" placeholder="Enter City" value="" required aria-describedby="basic-addon1" id="kstate">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="country" id="kin_nationality" style="border:#D3CACA solid 1px; border-radius:0px;"  required class="form-control" >
                                ...
                                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-lg-8 col-lg-offset-2 text-center" style="margin-top: 20px;">
                                    <button type="submit"  id="register" class="button button-4x covered_but text_white" style="background-color:#336699;">Submit</button>
                                </div>
...
<div class="footer-copyright">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="copyright">
                    <p> <a href="#">Capecity Bank </a> © 2020. All rights reserved.</p>
                </div>
            </div>
            <div class="col-sm-6">
