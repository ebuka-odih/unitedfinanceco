    ...
    <div class="section-padding-top">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div>
                        <h3 class="accordion-title">e-Statements</h3>
                        <p class="subtext">The United IBF e-Statement service delivers your statements securely to your inbox.
                        </p>


                        <br>

                        <h6><p><b>Features of the e-Statement service:</p></h6></b>

                        <ul style="margin-top: 20px;">
                            <li dir="LTR">&#8226;<strong>&nbsp;</strong>Secure delivery of your statements;</li>
                            <li dir="LTR">&#8226;<strong>&nbsp;</strong>Eliminates lost/misplaced paper statements;</li>
                            <li dir="LTR">&#8226;<strong>&nbsp;</strong>Easily view, download and print your statements;</li>
                            <li dir="LTR">&#8226;<strong>&nbsp;</strong>Provides a fast, secure and easy method of monitoring your transactions;.</li>
                            <li dir="LTR">&#8226;<strong>&nbsp;</strong>Email notification once e-Statement is ready</li>
                            <li dir="LTR">&#8226;<strong>&nbsp;</strong>Electronic statements are stored for as long as possible on a secure cloud service.</li>

                        </ul>

                        <br>

                        <h6><p><b>Who can benefit?</p></h6></b>
                        <br>
                        <p>All United IBF account holders with valid email addresses registered with the bank are eligible for the service.
                        </p>
                    </div>
                </div>
            </div>
