                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-9 col-md-8">
                                    ...
                                    <div class="card-box">
                                        <div class="row">
                                            <div class="">
                                                    <form class="form-horizontal" action="{{ route('admin.personal_info_store', $user_details->id) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" name="first_name" class="form-control" value="{{ $user_details->first_name }}" placeholder="First Name">
                                                        </div>

                                                        <div class="form-group col-md-6">
                                                            <label for="inputZip">Last Name</label>
                                                            <input type="text" id="example-email" name="last_name" value="{{ $user_details->last_name }}" class="form-control" placeholder="Last Name">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="email" name="email" class="form-control" value="{{ $user_details->email }}"  readonly>
                                                        </div>

                                                        <div class="form-group col-md-6">
                                                            <label for="inputZip">Phone</label>
                                                            <input type="tel" name="phone" class="form-control" value="{{ $user_details->phone }}"  placeholder="Enter Phone Number">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select id="country" name="country" class="form-control">
                                                                ...
                                                                <option value="{{ old('country',$user_details->country)=='country' ? 'selected' : ''  }}">{{ $user_details->country }}</option>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" name="state" class="form-control" value="{{ $user_details->state }}" id="inputState" placeholder="Enter State">
                                                        </div>

                                                        <div class="form-group col-md-4">
                                                            <label for="inputCity">City</label>
                                                            <input type="text" name="city" class="form-control" value="{{ $user_details->city }}" id="inputCity" placeholder="Enter City">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <input type="text" name="address" class="form-control" value="{{ $user_details->address }}" placeholder="Enter User Address">
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <label for="inputCity">Zipcode</label>
                                                            <input type="text" name="zipcode" class="form-control" value="{{ $user_details->zipcode }}" placeholder="Enter Zipcode">
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" name="occupation" class="form-control" value="{{ $user_details->occupation }}" placeholder="Enter User Occupation">
                                                        </div>
                                                    </div>
                                                ...
                                                <hr>
                                                <h3 class="text text-center">Chanage Password</h3>
                                                <form action="">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
